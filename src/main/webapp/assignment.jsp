...
<div class="main-window page-item">
    ...
    <span style="font-size: 24px">
        <input type="text" class="assignment-input" id="title" placeholder="Type in title...">
    </span>
    <div style="padding-top: 10px; border-top:1px solid rgba(255, 255, 255, 0.5)">
    </div>

    <div style="font-size: 24px;">
        <textarea class="assignment-input" name="submit-text" id="question" style="margin-top: 10px" cols="50" rows="10" placeholder="Type your question..."></textarea>
